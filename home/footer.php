                    ...
                    <div class="col-md-8 ">
                        <div class="footer_widget">
                            ...
                            <div class="socail_links">
                                <ul>
                                    <li>
                                        <a href="https://www.facebook.com/beacukaimalang/">
                                            <i class="ti-facebook"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://twitter.com/beacukaimalang?lang=id">
                                            <i class="ti-twitter-alt"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.instagram.com/beacukaimalang/?hl=id">
                    ...
                    <div class="col-md-4 ">
                        <div class="footer_widget">
                            ...
                            <ul class="links">
                                ...
                                <li><a href="about.php">Tata Cara</a></li>
